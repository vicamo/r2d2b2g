 ...
 */
function FakeMobileMessageDatabaseService() {
...
FakeMobileMessageDatabaseService.prototype = {
  classID:          Components.ID("{cd7a41cf-0429-4943-827f-aa548cac895a}"),
  QueryInterface:   XPCOMUtils.generateQI([Ci.nsIMobileMessageDatabaseService]),
...
GetMessagesCursor.prototype = {
  classID: Components.ID("{89d49204-60f2-48cd-b999-b7fe927104bc}"),
...
GetThreadsCursor.prototype = {
  classID: Components.ID("{e3be3da3-0419-476d-a94e-a156ce8f701c}"),
  QueryInterface: XPCOMUtils.generateQI([Ci.nsICursorContinueCallback]),
...
this.NSGetFactory = XPCOMUtils.generateNSGetFactory([FakeMobileMessageDatabaseService]);
